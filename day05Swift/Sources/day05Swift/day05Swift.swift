...
extension String {
    ...
    func missingSeat() -> Int? { allSeats().missingSeat()}
}

extension Array where Element == Int {
    func missingSeat() -> Int {
        (zip(self,self.dropFirst()).first{ (seat1, seat2) in seat1 + 1 != seat2}?.0 ?? 0) + 1
    }
}

func toSeatId(_ s:String) -> Int {s.binaryToInteger("BR")}
