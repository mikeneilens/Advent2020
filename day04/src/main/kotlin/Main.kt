...
const val passportSeparator = "\n\n"

fun String.toPassports() = split(passportSeparator)
...
fun Credentials.allValid() =
    map { credential -> passportFields[credential.key]?.let { rule -> rule(credential.value) } }.none { it == false }
