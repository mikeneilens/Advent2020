...
val hgtRule = { credential:String -> (credential.endsWith("cm") && credential.removeSuffix("cm").inRange(150, 193))
...
val pidRule = { credential:String ->  (credential.length == 9)  && (credential[0] != '-') && (credential.toLongOrNull() != null)}
