...
let passportFields = ["byr":byrRule,
                    ...
                    "pid":pidRule,
                    "cid":cidRule,]
let northPoleCredentialFields = ["byr":byrRule,
                                "iyr":iyrRule,
                                "eyr":eyrRule,
                                "hgt":hgtRule,
                                "hcl":hclRule,
                                "ecl":eclRule,
                                "pid":pidRule,] // need to find a nice way to make this a subset of passPortFields

typealias Credentials = Dictionary<String, String>
...
extension Credentials {
    func passportFieldsArePresent() -> Bool {
        Set(keys).isSuperset(of: Set(passportFields.keys))
    }
